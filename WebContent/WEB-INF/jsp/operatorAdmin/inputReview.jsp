...
<body>
<form class="newApplication" id="form1" method="post" action="SubmitInputReview" enctype="multipart/form-data">
...
<input name="tag" value="<s:property value="tag" />" type="hidden"/> 
   <table class="table table-bordered" >
     ...
     <tr>
      ...
      <tr>
       <td colspan="11" ><div style="height:80px;position:relative;">
   ...
   <br />
   <input class="btn btn-primary f-fr" style="margin-left: 20px;width:70px;" type="button" onclick="checkSelected()" value="提 交" ></input>
   <input class="btn btn-primary f-fr" onclick="history.go(-1)" type="button" value="返 回" style="width:70px;"/>
...
function checkSelected(){
	  ...
	  Showbo.Msg.confirm('评审意见提交后不能修改，确认提交吗?',function(flag){
			if(flag=='yes')	{	
				$("#form1").action="SubmitInputReview";
				$("#form1").submit();}
		});
}
var isSize = true;
